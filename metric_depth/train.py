...
parser.add_argument('--dataset', default='dense', choices=['hypersim', 'vkitti', 'dense', 'booster', 'ai4s'])
...
def main():
    ...
    if args.dataset == 'hypersim':
        ...
        trainset = Booster('dataset/splits/boooster/booster_train.txt', 'train', size=size)
    elif args.dataset == 'ai4s':
        trainset = AI4S('dataset/splits/AI4S/train_splits_full.txt', 'train', size=size)
    elif args.dataset == 'dense':
    ...
    if args.dataset == 'hypersim':
        ...
        valset = Booster('dataset/splits/boooster/booster_train.txt', 'val', size=size)
    elif args.dataset == 'ai4s':
        valset = AI4S('dataset/splits/AI4S/val_split_with_gt.txt', 'val', size=size)
    elif args.dataset == 'dense':
        ...
        if rank == 0:
            for k in save_metric:
                ...
                if flag:
                    ...
                    torch.save(checkpoint, os.path.join(args.save_path, f'{k}-{previous_best[k]}-{epoch}.pth'))
